...
describe('Service Tests', () => {
    ...
    describe('Permissao Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PermissaoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/permissaos/' + 123);
            });
            it('should return Permissao', () => {

                let entity: Permissao;
                service.find(123).subscribe((_entity: Permissao) => {
                    entity = _entity;
                });
