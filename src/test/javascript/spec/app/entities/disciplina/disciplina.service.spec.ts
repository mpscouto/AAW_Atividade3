...
describe('Service Tests', () => {
    ...
    describe('Disciplina Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DisciplinaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/disciplinas/' + 123);
            });
            it('should return Disciplina', () => {

                let entity: Disciplina;
                service.find(123).subscribe((_entity: Disciplina) => {
                    entity = _entity;
                });
