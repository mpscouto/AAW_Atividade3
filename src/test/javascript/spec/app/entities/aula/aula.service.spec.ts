...
describe('Service Tests', () => {
    ...
    describe('Aula Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AulaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/aulas/' + 123);
            });
            it('should return Aula', () => {

                let entity: Aula;
                service.find(123).subscribe((_entity: Aula) => {
                    entity = _entity;
                });
