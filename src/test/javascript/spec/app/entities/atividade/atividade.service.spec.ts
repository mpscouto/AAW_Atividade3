...
describe('Service Tests', () => {
    ...
    describe('Atividade Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(AtividadeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/atividades/' + 123);
            });
            it('should return Atividade', () => {

                let entity: Atividade;
                service.find(123).subscribe((_entity: Atividade) => {
                    entity = _entity;
                });
