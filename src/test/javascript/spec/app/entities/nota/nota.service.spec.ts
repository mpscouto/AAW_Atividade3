...
describe('Service Tests', () => {
    ...
    describe('Nota Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(NotaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/notas/' + 123);
            });
            it('should return Nota', () => {

                let entity: Nota;
                service.find(123).subscribe((_entity: Nota) => {
                    entity = _entity;
                });
